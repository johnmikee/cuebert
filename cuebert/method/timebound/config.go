...
type Cfg struct {
	...
	defaultReminderInterval int      // how often to remind users to update unless they opt for a different interval
}
...
func WithDefaultReminderInterval(interval int) Option {
	return func(cfg *Cfg) {
		cfg.defaultReminderInterval = interval
	}
}
