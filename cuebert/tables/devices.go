...
func (d *Devices) add() *devices.Update {
	return d.dev(d.db, &d.log).Add()
}

// AddDevice provides access to the DeviceUpdate.Add() method
func (d *Devices) AddDevice() *devices.Update {
	return d.add()
}

func (d *Devices) remove() *devices.Remove {
	return d.dev(d.db, &d.log).Remove()
}

// RemoveDevice provides access to the DeviceRemove method
func (d *Devices) RemoveDeviceBy() *devices.Remove {
	return d.remove()
}

func (d *Devices) query() *devices.Query {
	return d.dev(d.db, &d.log).Query()
}

// QueryDeviceBy provides access to the Query.By() method
func (d *Devices) QueryDeviceBy() *devices.Query {
	return d.query()
}

func (d *Devices) update() *devices.Update {
	return d.dev(d.db, &d.log).Update()
}

// UpdateDeviceBy provides access to the DeviceUpdate.Update() method
func (d *Devices) UpdateDeviceBy() *devices.Update {
	return d.update()
}

// AddAll adds all devices provided to the devices table
func (d *Devices) AddAll(machines devices.DI) error {
...
func (d *Devices) GetAllDevices() (devices.DI, error) {
...
func (d *Devices) DeviceByEmail(email string) (devices.DI, error) {
	return d.query().User(email).Query()
}

// DevicesByUser returns all devices for a user from the devices table
func (d *Devices) DevicesByUser(user string) (devices.DI, error) {
